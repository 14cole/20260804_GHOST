...
def current_plot_report_setup(window):
    ...
    from ppt_plot_data import NamedGrid, get_plot_availability
    from plot_modes.common import axis_unit, convert_axis_values
...
class ReportWorkflowMixin:
    ...
    def _install_report_setup(self,value,*,strict):
        from ppt_workspace import _find_combo_value, _AXIS_VALUE_ROLE, _axis_values_equal, _CATALOG_ID_ROLE

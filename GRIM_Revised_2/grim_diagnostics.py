...
GRIM_STARTUP_FILES = (
    "assembly_interference.py",
    "assembly_placement_editor.py",
    "assembly_response_comparison.py",
    "assembly_tree.py",
    "assembly_workflow.py",
    "assembly_workspace.py",
    "dataset_dialogs.py",
    "dataset_jobs.py",
    "dataset_plot_style.py",
    "dataset_sidebar.py",
    ...
    "grim_backend/__init__.py",
    "grim_backend/cli.py",
    "grim_backend/datasets/__init__.py",
    "grim_backend/datasets/arithmetic.py",
    "grim_backend/datasets/audit.py",
    "grim_backend/datasets/axes.py",
    "grim_backend/datasets/calibration.py",
    "grim_backend/datasets/combine.py",
    "grim_backend/datasets/constants.py",
    "grim_backend/datasets/coordinates.py",
    "grim_backend/datasets/grid.py",
    "grim_backend/datasets/memory.py",
    "grim_backend/datasets/metadata.py",
    "grim_backend/datasets/transforms.py",
    "grim_backend/io/__init__.py",
    "grim_backend/io/batch.py",
    "grim_backend/io/cst.py",
    "grim_backend/io/csv.py",
    "grim_backend/io/loaders.py",
    "grim_backend/io/native.py",
    "grim_backend/io/out.py",
    "grim_backend/io/pioneer.py",
    "grim_backend/io/ptm.py",
    "grim_backend/io/samples.py",
    "grim_backend/io/sentri.py",
    "grim_backend/io/xpatch.py",
    "grim_backend/scripting/__init__.py",
    "grim_backend/scripting/plotting.py",
    "grim_backend/scripting/recorder.py",
    ...
    "isar_artifact.py",
    "plot_models.py",
    "plot_modes/__init__.py",
    "plot_modes/az_vs_range_mode.py",
    "plot_modes/azimuth_polar_mode.py",
    "plot_modes/azimuth_rect_mode.py",
    "plot_modes/common.py",
    "plot_modes/compare_mode.py",
    "plot_modes/elevation_sweep_mode.py",
    "plot_modes/frequency_mode.py",
    "plot_modes/isar_mode.py",
    "plot_modes/isar_render.py",
    "plot_modes/waterfall_mode.py",
    "ppt_plot_data.py",
    "ppt_report.py",
    "ppt_workflow.py",
    "ppt_workspace.py",
...
GHOST_MODULE_LOCATIONS = {
    'assembly_geometry': 'ghost_backend/twod/assembly/geometry_plan.py',
    'assembly_inspector': 'ghost_backend/assembly/inspector.py',
    'assembly_session': 'ghost_backend/twod/assembly/session.py',
    'assembly_workload': 'ghost_backend/assembly/workload.py',
    'bor_dispatch': 'ghost_backend/bor/dispatch.py',
    'bor_kernels': 'ghost_backend/bor/kernels.py',
    'bor_solver': 'ghost_backend/bor/solver.py',
    'bor_streaming': 'ghost_backend/bor/streaming.py',
    'boundary_fields': 'ghost_backend/twod/fields.py',
    'compact_operators': 'ghost_backend/twod/assembly/compact.py',
    'components': 'ghost_backend/assembly/components.py',
    'compressed_factor': 'ghost_backend/compressed/factor.py',
    'compressed_inverse': 'ghost_backend/compressed/inverse.py',
    'compressed_memory': 'ghost_backend/compressed/memory.py',
    'compressed_native': 'ghost_backend/compressed/coefficients.py',
    'compressed_operator': 'ghost_backend/compressed/operator.py',
    'compressed_oracle': 'ghost_backend/compressed/regional_coefficients.py',
    'compressed_pair': 'ghost_backend/compressed/polarization_cache.py',
    'compressed_runtime': 'ghost_backend/compressed/runtime.py',
    'cpu_execution': 'ghost_backend/execution/cpu.py',
    'cpu_kernels': 'ghost_backend/twod/assembly/kernels.py',
    'dense_factor': 'ghost_backend/linalg/dense.py',
    'dense_workspace': 'ghost_backend/linalg/workspace.py',
    'dielectric_system': 'ghost_backend/twod/formulations/dielectric.py',
    'driver_config': 'ghost_backend/runs/config.py',
    'driver_io': 'ghost_backend/runs/inputs.py',
    'feature_library_contracts': 'ghost_backend/assembly/contracts.py',
    'feature_preparation': 'ghost_backend/assembly/preparation.py',
    'feature_sum': 'ghost_backend/assembly/fields.py',
    'feature_workflow': 'ghost_backend/assembly/workflow.py',
    'frame': 'ghost_backend/geometry/frames.py',
    'geometry_io': 'ghost_backend/geometry/io.py',
    'geometry_tab': 'ghost_backend/ui/geometry.py',
    'ghost_gui': 'ghost_backend/ui/app.py',
    'ghost_runtime': 'ghost_backend/execution/runtime.py',
    'grim_compat': 'ghost_backend/io/viewer_bridge.py',
    'grim_io': 'ghost_backend/io/grim.py',
    'grim_naming': 'ghost_backend/io/naming.py',
    'hierarchical_factor': 'ghost_backend/linalg/hierarchical.py',
    'hpc_bundle': 'ghost_backend/hpc/bundle.py',
    'hpc_common': 'ghost_backend/hpc/common.py',
    'hpc_scheduler': 'ghost_backend/hpc/scheduler.py',
    'line_expand': 'ghost_backend/assembly/line_expansion.py',
    'local_mass': 'ghost_backend/twod/assembly/mass.py',
    'material_models': 'ghost_backend/geometry/materials.py',
    'mesh_guidance': 'ghost_backend/geometry/guidance.py',
    'mesh_quality': 'ghost_backend/geometry/quality.py',
    'mie_reference': 'ghost_backend/validation/cylinder.py',
    'mie_sphere': 'ghost_backend/validation/sphere.py',
    'multi_region': 'ghost_backend/twod/formulations/regions.py',
    'occluder': 'ghost_backend/geometry/occlusion.py',
    'rcs_constants': 'ghost_backend/twod/constants.py',
    'rcs_geometry': 'ghost_backend/twod/geometry.py',
    'rcs_operators': 'ghost_backend/twod/operators.py',
    'rcs_solver': 'ghost_backend/twod/solver.py',
    'rcs_special': 'ghost_backend/twod/special.py',
    'refined_lu': 'ghost_backend/linalg/refined_lu.py',
    'robin_system': 'ghost_backend/twod/formulations/robin.py',
    'run_setup': 'ghost_backend/runs/setup.py',
    'sheet_system': 'ghost_backend/twod/formulations/sheet.py',
    'solver_metrics': 'ghost_backend/execution/metrics.py',
    'solver_quality': 'ghost_backend/runs/quality.py',
    'solver_tab': 'ghost_backend/ui/solver.py',
    'surface_mesh': 'ghost_backend/geometry/surface.py',
    'sweep_compression': 'ghost_backend/linalg/sweep.py',
    'system_scatter': 'ghost_backend/twod/assembly/scatter.py',
    'thin_sheet': 'ghost_backend/twod/formulations/thin_layer.py',
    'workflow_provenance': 'ghost_backend/execution/provenance.py',
}
...
GHOST_SENTINELS = (
    ...
    "feature_workflow.py",
    "geometry_io.py",
    "ghost_backend/__init__.py",
    "ghost_backend/assembly/__init__.py",
    "ghost_backend/assembly/components.py",
    "ghost_backend/assembly/contracts.py",
    "ghost_backend/assembly/fields.py",
    "ghost_backend/assembly/inspector.py",
    "ghost_backend/assembly/line_expansion.py",
    "ghost_backend/assembly/preparation.py",
    "ghost_backend/assembly/workflow.py",
    "ghost_backend/assembly/workload.py",
    "ghost_backend/bor/__init__.py",
    "ghost_backend/bor/dispatch.py",
    "ghost_backend/bor/kernels.py",
    "ghost_backend/bor/solver.py",
    "ghost_backend/bor/streaming.py",
    "ghost_backend/compressed/__init__.py",
    "ghost_backend/compressed/coefficients.py",
    "ghost_backend/compressed/factor.py",
    "ghost_backend/compressed/inverse.py",
    "ghost_backend/compressed/memory.py",
    "ghost_backend/compressed/operator.py",
    "ghost_backend/compressed/polarization_cache.py",
    "ghost_backend/compressed/regional_coefficients.py",
    "ghost_backend/compressed/runtime.py",
    "ghost_backend/execution/__init__.py",
    "ghost_backend/execution/cpu.py",
    "ghost_backend/execution/metrics.py",
    "ghost_backend/execution/provenance.py",
    "ghost_backend/execution/runtime.py",
    "ghost_backend/execution/options.py",
    "ghost_backend/runs/execution.py",
    "ghost_backend/ui/execution.py",
    "ghost_backend/geometry/__init__.py",
    "ghost_backend/geometry/frames.py",
    "ghost_backend/geometry/guidance.py",
    "ghost_backend/geometry/io.py",
    "ghost_backend/geometry/materials.py",
    "ghost_backend/geometry/occlusion.py",
    "ghost_backend/geometry/quality.py",
    "ghost_backend/geometry/surface.py",
    "ghost_backend/hpc/__init__.py",
    "ghost_backend/hpc/bundle.py",
    "ghost_backend/hpc/common.py",
    "ghost_backend/hpc/scheduler.py",
    "ghost_backend/io/__init__.py",
    "ghost_backend/io/grim.py",
    "ghost_backend/io/naming.py",
    "ghost_backend/io/viewer_bridge.py",
    "ghost_backend/linalg/__init__.py",
    "ghost_backend/linalg/dense.py",
    "ghost_backend/linalg/hierarchical.py",
    "ghost_backend/linalg/refined_lu.py",
    "ghost_backend/linalg/sweep.py",
    "ghost_backend/linalg/workspace.py",
    "ghost_backend/paths.py",
    "ghost_backend/runs/__init__.py",
    "ghost_backend/runs/config.py",
    "ghost_backend/runs/inputs.py",
    "ghost_backend/runs/quality.py",
    "ghost_backend/runs/setup.py",
    "ghost_backend/twod/__init__.py",
    "ghost_backend/twod/assembly/__init__.py",
    "ghost_backend/twod/assembly/compact.py",
    "ghost_backend/twod/assembly/geometry_plan.py",
    "ghost_backend/twod/assembly/kernels.py",
    "ghost_backend/twod/assembly/mass.py",
    "ghost_backend/twod/assembly/scatter.py",
    "ghost_backend/twod/assembly/session.py",
    "ghost_backend/twod/constants.py",
    "ghost_backend/twod/fields.py",
    "ghost_backend/twod/formulations/__init__.py",
    "ghost_backend/twod/formulations/dielectric.py",
    "ghost_backend/twod/formulations/regions.py",
    "ghost_backend/twod/formulations/robin.py",
    "ghost_backend/twod/formulations/sheet.py",
    "ghost_backend/twod/formulations/thin_layer.py",
    "ghost_backend/twod/geometry.py",
    "ghost_backend/twod/operators.py",
    "ghost_backend/twod/solver.py",
    "ghost_backend/twod/special.py",
    "ghost_backend/ui/__init__.py",
    "ghost_backend/ui/app.py",
    "ghost_backend/ui/geometry.py",
    "ghost_backend/ui/solver.py",
    "ghost_backend/validation/__init__.py",
    "ghost_backend/validation/cylinder.py",
    "ghost_backend/validation/sphere.py",
    "ghost_gui.py",
    "grim_compat.py",
    "grim_io.py",
    "hpc_bundle.py",
    ...
    "validate_feature_reconstruction.py",
...
def ghost_module_paths(backend: Path) -> dict[str, str]:
    ...
    for path in (backend / 'ghost_backend').rglob('*.py'):

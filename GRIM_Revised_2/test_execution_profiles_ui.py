...
class ExecutionProfilesUI(unittest.TestCase):
    ...
    def test_advanced_controls_are_collapsed_without_changing_the_setup(self):
        ...
        try:
            ...
            for control in (tab.edit_geo_path, tab.cmb_lu_precision, tab.cmb_solver_method,
            ...
            for control in (tab.cmb_solver_kind, tab.cmb_units, tab.cmb_freq_mode, tab.cmb_elev_mode,

...
from GRIM_Backend.runs.workspace import (
    ConnectionValues,
    RunsWorkspace,
    TrackedRun,
    _parse_number_list,
...
class RunsWorkspaceTests(unittest.TestCase):
    ...
    def _configure_connection(self) -> None:
        ...
        self.workspace.remote_cli_edit.setText(
            "/cluster/GHOST/ghost_backend/hpc/bundle.py"
        )
    ...
    def test_current_form_is_accepted_by_real_hpc_bundle_contract(self) -> None:
        from GRIM_Backend.integrations.ghost import discover_ghost_backend, load_ghost_module
    ...
    def test_default_config_adapter_matches_hpc_remote_factories(self) -> None:
        from GRIM_Backend.runs.remote import Transport

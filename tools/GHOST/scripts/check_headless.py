...
names=('polynomial_basis','adaptive_polynomial','automatic_backend','automatic_hpc','batch_presets','fmm','nystrom','near_separation','direct_solver_methods','execution_options',

...
names=('automatic_backend','automatic_hpc','batch_presets','fmm','nystrom','near_separation','direct_solver_methods','execution_options',
       'rcs_physics_regression','2d_capability_acceptance','experimental_cpu',

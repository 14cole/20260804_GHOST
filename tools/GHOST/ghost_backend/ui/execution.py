...
class ExecutionOptionsWidget(QGroupBox):
    ...
    def __init__(self, parent=None):
        ...
        self.storage_spin.setToolTip('Retained compressed operator and inverse payload, including partner polarization. Workspaces and process overhead require additional RAM.')
        ...
        self.assembly_spin.setToolTip('Auto lets batch scheduling choose assembly concurrency; desktop solves use one assembly thread.')
